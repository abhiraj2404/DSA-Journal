...
public:
    ...
    {
        // this is the ITERATIVE solution. A RECURSIVE solution also exists
        int n = nums.size();
        int low = 0, high = n - 1, mid;
        while (low <= high)
        {
            mid = (low + high) / 2;
            cout << "low=" << nums[low] << ", high=" << nums[high] << endl;
            // bool isequal = nums[mid] == target;
            if (nums[mid] == target)
                return mid;
